<x-layouts.layout>
    ...
    <form  class="max-w-md mx-auto"  method="POST" action="{{ route('clientes.update', $cliente->id )}}"> {{-- onsubmit="(e)=>e.preventDefault()" --}}
        @method('PUT')
        @csrf
        <div class="relative z-0 w-full mb-5 group">
            ...
            <input name="nombre" type="text" value="{{ $cliente->nombre }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required />
        </div>
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <input name="email" type="text" value="{{ $cliente->email }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required />
        </div>
        @if ($errors->get("email"))
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
          ...
          @endif
           <div class="relative z-0 w-full mb-5 group">
              ...
              <input name="edad" type="text" value="{{ $cliente->edad }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required />
        </div>
          @if ($errors->get("edad"))
        ...
        <button onclick="handleConfirm()" type="submit" class="mr-2 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Actualizar</button>
